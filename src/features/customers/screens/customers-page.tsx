...
import { CustomerCreateModalButton } from "@/features/customers/components/customer-create-modal";
import { CustomerDeleteButton } from "@/features/customers/components/customer-delete-button";
import { CustomerUpdateModalButton } from "@/features/customers/components/customer-update-modal";
import type { CustomerListItem } from "@/services/server/customers.service";
...
export default function CustomersPage({ q, status, page, totalCustomers, customers, userRole }: CustomersPageProps) {
                  ...
                  <tr key={customer.id} className="border-b border-slate-100 align-top">
                    ...
                    <td className="py-2 pr-3">
                      <div className="flex justify-end gap-2">
                        ...
                        {userRole === Role.ADMIN_EMPRESA ? <CustomerDeleteButton customerId={customer.id} /> : null}
                      </div>
                    </td>
                  </tr>
                );
...
function buildCustomersUrl(q: string, status: CustomerStatusFilter, page: number) {
