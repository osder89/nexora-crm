...
import { SupplierCreateModalButton } from "@/features/purchases/components/supplier-create-modal";
import type { SupplierListItem } from "@/services/server/purchases.service";
...
export default function SuppliersPage({ q, status, page, totalSuppliers, suppliers, userRole }: SuppliersPageProps) {
...
function buildSuppliersUrl({ q, status, page }: { q: string; status: SupplierStatusFilter; page: number }) {
